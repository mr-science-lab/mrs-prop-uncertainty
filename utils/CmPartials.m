...
%           float or int: Am, Sw, TE, TR ,T1m, T2m, f_grey, f_white, f_csf,
    ...
    methods
        ...
        function val = partial_Sw(obj)
            ...
            val = (-1/(obj.consts.Sw^2)) * ...
                  (obj.consts.Am * exp(obj.consts.TE / obj.consts.T2m) * ...
        ...
        function val = partial_T1m(obj)
            ...
            R_dT1m = (obj.consts.Am * exp(obj.consts.TE/obj.consts.T2m)) ...
                     / (obj.consts.Sw * (obj.consts.f_white + obj.consts.f_grey)) * obj.f_sum;
        ...
        function val = partial_T2m(obj)
            ...
            val = exp(obj.consts.TE / obj.consts.T2m)   * ...
                  ...
                  (obj.consts.Am*obj.Dm)/(obj.consts.Sw * ...
        ...
        function val = partial_TE(obj)
            ...
            % group scalar factor
            R_dTE = (obj.consts.Am*obj.Dm)/(obj.consts.Sw*(obj.consts.f_white + obj.consts.f_grey));
        ...
        function val = partial_TR(obj)
            ...
            % shared terms
            R_dTR = obj.consts.Am*exp(obj.consts.TE/obj.consts.T2m) ...
        ...
        function val = partial_T1grey(obj)
            ...
            R_dT1_grey = (obj.consts.Am*exp(obj.consts.TE/obj.consts.T2m) ...
        ...
        function val = partial_T1white(obj)
            ...
            R_dT1_white = (obj.consts.Am*exp(obj.consts.TE/obj.consts.T2m) ...
        ...
        function val = partial_T1csf(obj)
            ...
            R_dT1_csf = (obj.consts.Am*exp(obj.consts.TE/obj.consts.T2m) ...
        ...
        function val = partial_T2grey(obj)
            ...
            R_dT2_grey  = (obj.consts.Am*exp(obj.consts.TE/obj.consts.T2m) ...
        ...
        function val = partial_T2white(obj)
            ...
            % all T2w_i exprssions should have (1-f_csf) in denominator
            R_dT2_white = (obj.consts.Am*exp(obj.consts.TE/obj.consts.T2m) ...
        ...
        function val = partial_T2csf(obj)
            ...
            % all T2w_i exprssions should have (1-f_csf) in denominator
            R_dT2_csf = (obj.consts.Am*exp(obj.consts.TE/obj.consts.T2m) ...
        ...
        function val = Cm(obj)
           val = (obj.consts.Am  .* exp(obj.consts.TE ./ obj.consts.T2m) .* obj.Dm) ...
               ./ (obj.consts.Sw .* (obj.consts.f_white + obj.consts.f_grey)) .* obj.f_sum;
        end
        ...
        function val = cwi_shared(obj)
            val = (obj.consts.Am * exp(obj.consts.TE/obj.consts.T2m) ...
        ...
        function R = shared_fi_terms(obj)
            ...
            R.fshared = obj.consts.Am * exp(obj.consts.TE/obj.consts.T2m) ...
